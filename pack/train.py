...
from pack.plot import LearningDashboard
from pack.test import Tester
...
def train_agent(     
    ...
    board = LearningDashboard(model_name, pulse_ticks)

    # set the range of noise stddevs for noise test
    noise_test_stddevs = np.logspace(-4, 0, 17)
    tester = Tester(env, agent, driver, noise_test_stddevs, num_noise_test_samples, noise_test_interval, ideal_weight, noise_weight)
