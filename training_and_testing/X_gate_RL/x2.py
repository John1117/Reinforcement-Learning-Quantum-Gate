...
main_path = '/Users/john/personal/myself/projects/machine_learning_quantum_gate/record/noisy_x'
model_name = 'x11'
...
with tf.device('/cpu'):
    ...
    agent = load_network(agent, main_path + '/x9/network/611', use_stddev_proj_network=False)
