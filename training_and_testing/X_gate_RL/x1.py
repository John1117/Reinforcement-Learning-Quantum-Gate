...
init_learning_rate = 1e-10
actor_network_config = (8, 8)
value_network_config = (8, 8)
init_action_stddev = np.array(1e-6, dtype)
...
main_path = '/Users/john/personal/myself/projects/MLQuantGate/record/noisy_x_nw'
model_name = 'x9'
...
with tf.device('/cpu'):
    ...
    old_main_path = '/Users/john/personal/myself/projects/MLQuantGate/record/noisy_x_nw'
    agent = load_network(agent, old_main_path + '/x8/network/29', use_stddev_proj_network=False)
