...
init_action_stddev = np.array(5e-1, dtype)
...
main_path = '/Users/john/personal/myself/projects/machine_learning_quantum_gate/record/noisy_h_try_n1e-1'
model_name = 'h8'
...
with tf.device('/cpu'):
    ...
    #old_main_path = '/Users/john/personal/myself/projects/machine_learning_quantum_gate/record/noisy_h_32_slow_tl/n3e-3'
    #agent = load_network(agent, old_main_path + '/h3/network/3254', use_stddev_proj_network=False)
