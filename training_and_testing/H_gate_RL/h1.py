...
init_action_stddev = np.array(3e-1, dtype)
...
revolution_interval = 1 #np.inf
adapt_interval = 1 # np.inf
...
main_path = '/Users/john/personal/myself/projects/machine_learning_quantum_gate/record/ideal_h_T4_N16'
model_name = 'h1'
...
with tf.device('/cpu'):
    ...
    #old_main_path = '/Users/john/personal/myself/projects/machine_learning_quantum_gate/record/noisy_h_nw'
    #agent = load_network(agent, old_main_path + '/h6/network/403', use_stddev_proj_network=False)
