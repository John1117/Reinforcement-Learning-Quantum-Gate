...
init_learning_rate = 1e-12
actor_network_config = (32, 32)
value_network_config = (32, 32)
init_action_stddev = np.array(1e-7, dtype)
...
main_path = '/Users/john/personal/myself/projects/MLQuantGate/record/noisy_h_nw'
model_name = 'h8'
...
with tf.device('/cpu'):
    ...
    old_main_path = '/Users/john/personal/myself/projects/MLQuantGate/record/noisy_h_nw'
    agent = load_network(agent, old_main_path + '/h7/network/725', use_stddev_proj_network=False)
